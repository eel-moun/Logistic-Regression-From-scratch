import pandas as pd
import sys
from utils import my_count, my_mean, my_max, my_min, my_percentile, my_std, my_total_count, my_nan_count
...
def describe(dataframe: pd.DataFrame):
    ...
    for column in num_df.columns:
        ...
        temp_filler = {
            ...
            'nan count': my_nan_count(column_serie),
            'total count': my_total_count(column_serie),
